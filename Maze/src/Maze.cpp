...
GridLoc Maze::GetChestLoc()
{
   ...
   val.x = (int)(chestLoc.x +(1+unitWidth/2))/(unitWidth);
   val.y = (int)(chestLoc.y +(1+unitWidth/2))/(unitWidth);
...
GridLoc Maze::GetStArrwsLoc()
{
   ...
   val.x = (int)(setOfArrsLoc.x +(1+unitWidth/2))/(unitWidth);
   val.y = (int)(setOfArrsLoc.y +(1+unitWidth/2))/(unitWidth);
